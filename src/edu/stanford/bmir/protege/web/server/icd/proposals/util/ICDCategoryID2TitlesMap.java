...
public class ICDCategoryID2TitlesMap extends EntityID2TitlesMap {

	private static final long serialVersionUID = 954684727887607070L;

	
	public ICDCategoryID2TitlesMap(ICDContentModel cm, boolean buildFullMap) {
		super(cm, buildFullMap);
	}

	public ICDCategoryID2TitlesMap(EntityTitle2IDMap title2idMap) {
		super(title2idMap);
	}
