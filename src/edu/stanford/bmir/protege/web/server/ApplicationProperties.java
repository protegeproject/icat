...
public class ApplicationProperties {
     ...
     * 
     */
    private static final String WEBPROTEGE_AUTHENTICATE_WITH_OPENID_PROP = "webprotege.authenticate.with.openid";
    private static final boolean WEBPROTEGE_AUTHENTICATE_WITH_OPENID_DEFAULT = true;

    private static final String LOGIN_WITH_HTTPS_PROP = "login.with.https";
    private static final boolean LOGIN_WITH_HTTPS_DEFAULT = false;

    private static final String APPLICATION_PORT_HTTPS_PROP = "application.https.port";
    private static final String APPLICATION_PORT_HTTPS_DEFAULT = "";

    private static final String SERVER_POLLING_TIMEOUT_MINUTES_PROP = "server.polling.timeout.min";
    private static final int SERVER_POLLING_TIMEOUT_MINUTES_DEFAULT = 10;
    ...
    */
    ...
    public static String getProtegeServerHostName() {
        return edu.stanford.smi.protege.util.ApplicationProperties.getString(PROTEGE_SERVER_HOSTNAME_PROP,
                PROTEGE_SERVER_HOSTNAME_DEFAULT);
    }

    public static String getProtegeServerUser() {
        return edu.stanford.smi.protege.util.ApplicationProperties.getString(PROTEGE_SERVER_USER_PROP,
                PROTEGE_SERVER_USER_DEFAULT);
    }

    public static String getProtegeServerPassword() {
        return edu.stanford.smi.protege.util.ApplicationProperties.getString(PROTEGE_SERVER_PASSWORD_PROP,
    ...
    public static boolean getLoadOntologiesFromServer() {
        return edu.stanford.smi.protege.util.ApplicationProperties.getBooleanProperty(
                LOAD_ONTOLOGIES_FROM_PROTEGE_SERVER_PROP, LOAD_ONTOLOGIES_FROM_PROTEGE_SERVER_DEFAULT);
    }

    public static int getLocalProjectSaveInterval() {
        return edu.stanford.smi.protege.util.ApplicationProperties.getIntegerProperty(SAVE_INTERVAL_PROP,
    ...
    public static String getApplicationName() {
        return edu.stanford.smi.protege.util.ApplicationProperties.getString(APPLICATION_NAME_PROP,
                APPLICATION_NAME_DEFAULT);
    }

    public static boolean getWebProtegeAuthenticateWithOpenId() {
        return edu.stanford.smi.protege.util.ApplicationProperties.getBooleanProperty(
                WEBPROTEGE_AUTHENTICATE_WITH_OPENID_PROP, WEBPROTEGE_AUTHENTICATE_WITH_OPENID_DEFAULT);
    }

    public static boolean getLoginWithHttps() {
        return edu.stanford.smi.protege.util.ApplicationProperties.getBooleanProperty(
                LOGIN_WITH_HTTPS_PROP, LOGIN_WITH_HTTPS_DEFAULT);
    }

    public static String getApplicationHttpsPort() {
        return edu.stanford.smi.protege.util.ApplicationProperties.getString(
                APPLICATION_PORT_HTTPS_PROP, APPLICATION_PORT_HTTPS_DEFAULT);
    }

    public static int getServerPollingTimeoutMinutes() {
        return edu.stanford.smi.protege.util.ApplicationProperties.getIntegerProperty(SERVER_POLLING_TIMEOUT_MINUTES_PROP,
                SERVER_POLLING_TIMEOUT_MINUTES_DEFAULT);
    }
