...
public class ApplicationProperties {
     ...
     */
    private static final String FACEBOOK_APP_API_KEY_PROP = "facebook.app.api.key";
    private static final String FACEBOOK_APP_API_KEY_DEFAULT = "";
    ...
    public static String getFacebookApiKey() {
        return edu.stanford.smi.protege.util.ApplicationProperties.getString(FACEBOOK_APP_API_KEY_PROP, FACEBOOK_APP_API_KEY_DEFAULT);
    }
