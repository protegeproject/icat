...
public class AccessPolicyUtil {
        ...
        shareAccessWindow.addListener(new PanelListenerAdapter() {
            ...
            public void onBodyResize(Panel panel, String width, String height) {
                ...
                if (heightChange != 0) {
                    ...
                    readOnlyListPanelElement.getStyle().setHeight(new Double(newReadPanelHeight), Unit.PX);
                    writeListPanelElement.getStyle().setHeight(new Double(newWritePanelHeight), Unit.PX);
                }
            }
        });
    }
    ...
    private void addBorderAndColorToScrollPanel() {
        ...
        readOnlyListPanelElement.getStyle().setBorderStyle(BorderStyle.SOLID);
        readOnlyListPanelElement.getStyle().setBorderWidth(new Double("2"), Unit.PX);
        readOnlyListPanelElement.getStyle().setBackgroundColor("white");

        Element writeListPanelElement = writePermlistPanel.getElement();
        writeListPanelElement.getStyle().setBorderColor("black");
        writeListPanelElement.getStyle().setBorderStyle(BorderStyle.SOLID);
        writeListPanelElement.getStyle().setBorderWidth(new Double("2"), Unit.PX);
    ...
    private void updateAddUserListboxOnResize(Window addUserPermWindow, final VerticalPanel addUserPanel,
        ...
        if (heightChange != 0) {
            ...
            userListBox.getElement().getStyle().setHeight(new Double(listBoxHeight), Unit.PX);
        }
    }
