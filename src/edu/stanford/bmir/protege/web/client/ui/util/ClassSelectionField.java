...
public class ClassSelectionField extends TriggerField implements Selectable {
    ...
    public void setClsValues(Collection<EntityData> newValues) {
        ...
        super.setValue(values == null ? "" : UIUtil.commaSeparatedList(values));
    ...
    public ClassTreePortlet getSelectable() {
        if (classTreePortlet == null) {
            classTreePortlet = new ClassTreePortlet(project, false, false, false, allowMultipleSelection, topClass);
            classTreePortlet.setDraggable(false);
            classTreePortlet.setClosable(false);
            classTreePortlet.setCollapsible(false);
            classTreePortlet.setHeight(300);
            classTreePortlet.setWidth(450);
        }
