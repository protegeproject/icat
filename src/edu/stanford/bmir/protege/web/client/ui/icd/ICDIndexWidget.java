...
//                colConfig.setSortable(false);
    ...
    protected ColumnConfig createSynonymColumn() {
        ...
        synonymCol.setRenderer(createColumnRenderer(FormConstants.FIELD_TYPE_RADIO, null));
...
//        });
    ...
    protected ColumnConfig createNarrowerColumn() {
        ...
        narrowerCol.setRenderer(createColumnRenderer(FormConstants.FIELD_TYPE_RADIO, null));
    ...
    protected ColumnConfig createInclusionColumn() {
        ...
        inclusionCol.setRenderer(createColumnRenderer(FormConstants.FIELD_TYPE_CHECKBOX, null));
    ...
    protected void onDelete(int index) {
        ...
        if (value != null) {
            ICDServiceManager.getInstance().removeBaseIndexTerm(getProject().getProjectName(), getSubject().getName(),
                    value, GlobalSettings.getGlobalSettings().getUserName(), getDeleteValueOperationDescription(index),
                    new RemovePropertyValueHandler(index));
...
//                        }
//                    }
                } else if (isDeleteColumn(colIndex)) {
