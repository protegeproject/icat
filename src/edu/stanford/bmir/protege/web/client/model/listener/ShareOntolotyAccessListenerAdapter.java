...
public class ShareOntolotyAccessListenerAdapter implements ShareOntologyAccessListener {
    ...
    public void onUserLoggedInUpdateShareLink() {
    }

    public void closeShareAccessWindowOnSignOut() {
    }
}
