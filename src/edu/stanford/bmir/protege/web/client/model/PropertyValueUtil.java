...
public class PropertyValueUtil {
    ...
    public void deletePropertyValue(String projectName, String entityName, String propName, ValueType propValueType,
                                    PropertyType propertyType, String value, String user, String operationDescription, AsyncCallback<Void> asyncCallback) {
        if (propValueType == null) {
            propValueType = ValueType.String;
        }
        EntityData oldEntityData = new EntityData(value);
        oldEntityData.setValueType(propValueType);
        final PropertyEntityData propertyData = new PropertyEntityData(propName);
        propertyData.setPropertyType(propertyType);
        OntologyServiceManager.getInstance().removePropertyValue(projectName, entityName,
                propertyData, oldEntityData, user, operationDescription,
    ...
    public void replacePropertyValue(String projectName, String entityName, String propName, ValueType propValueType,
                                     PropertyType propertyType, String oldValue, String newValue, String user, String operationDescription,
                                     AsyncCallback<Void> asyncCallback) {
        if (propValueType == null) {
            propValueType = ValueType.String;
        }
        final EntityData oldEntityData = new EntityData(oldValue);
        oldEntityData.setValueType(propValueType);
        final EntityData newEntityData = new EntityData(newValue);
        newEntityData.setValueType(propValueType);
        final PropertyEntityData propertyData = new PropertyEntityData(propName);
        propertyData.setPropertyType(propertyType);
        propertyData.setValueType(propValueType);
        OntologyServiceManager.getInstance().replacePropertyValue(projectName, entityName,
                propertyData, oldEntityData, newEntityData, user, operationDescription,
    ...
    public void addPropertyValue(String projectName, String entityName, String propName, ValueType propValueType,
        ...
        newEntityData.setValueType(propValueType);
        final PropertyEntityData propertyData = new PropertyEntityData(propName);
        //TODO: we make the assumption that this is an annotaiton type
        propertyData.setPropertyType(PropertyType.ANNOTATION);
        OntologyServiceManager.getInstance().addPropertyValue(projectName, entityName,
                propertyData, newEntityData, user, operationDescription,
