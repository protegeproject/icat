...
public interface OpenIdServiceAsync {
    ...
    void isFacebookProfileInSessForAddNewOpenId(AsyncCallback<UserData> callback);
    ...
    void checkIfUserCreatedToAssocOpenId(AsyncCallback<String> callback);

    void regUserToAssocOpenIdWithEncrption(String name, String hashedPassword, String emailId,
            AsyncCallback<UserData> callback);

    void clearAuthUserToAssocOpenIdSessData(AsyncCallback<Void> callback);

    void checkIfUserAuthenticatedToAssocOpenId(AsyncCallback<String> callback);

    void getFacebookAPIKey(AsyncCallback<String> callback);
