...
public class OntologyServiceManager {
    ...
    public void moveCls(String projectName, String clsName, String oldParentName, String newParentName, String user,
            String operationDescription, AsyncCallback<Void> cb) {
        proxy.moveCls(projectName, clsName, oldParentName, newParentName, user, operationDescription, cb);
    }
    ...
    public void getAllImplementedClasses(String projectName, EntityData data, AsyncCallback<List<EntityData>> cb){
        proxy.getAllImplementedClasses(projectName, data, cb);
    }
}
