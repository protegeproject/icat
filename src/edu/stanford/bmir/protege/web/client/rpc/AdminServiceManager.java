...
public class AdminServiceManager {
    ...
    public void isLoginWithHttps(AsyncCallback<Boolean> cb) {
        proxy.isLoginWithHttps(cb);
    }
    ...
    public void getApplicationHttpsPort(AsyncCallback<String> cb) {
        proxy.getApplicationHttpsPort(cb);
    }

    public void getServerPollingTimeoutMin(AsyncCallback<Integer> cb) {
        proxy.getServerPollingTimeoutMin(cb);
    }
    ...
    public void registerUserViaEncrption(String name, String hashedPassword, String emailId, AsyncCallback<UserData> cb) {
