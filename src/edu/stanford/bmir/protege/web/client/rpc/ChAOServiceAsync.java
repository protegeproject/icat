...
public interface ChAOServiceAsync {
    ...
    void getChangesByDescription(String projectName, String entityName, String filterString, int start, int limit,
            String sort, String dir, AsyncCallback<PaginationData<ChangeData>> callback);

    void getChangesByAuthor(String projectName, String entityName, String filterString, int start, int limit, String sort,
            String dir, AsyncCallback<PaginationData<ChangeData>> callback);
    
    void getChangesByDate(String projectName, String entityName, Date fromDate, Date toDate, int start, int limit, String sort,
            String dir, AsyncCallback<PaginationData<ChangeData>> callback);
