...
public class OpenIdServiceManager {
    ...
    private static OpenIdServiceManager instance;
    ...
    public void isFacebookProfileInSessForAddNewOpenId(AsyncCallback<UserData> cb) {
        proxy.isFacebookProfileInSessForAddNewOpenId(cb);
    }
    ...
    public void checkIfUserCreatedToAssocOpenId(AsyncCallback<String> cb) {
        proxy.checkIfUserCreatedToAssocOpenId(cb);
    }

    public void regUserToAssocOpenIdWithEncrption(String name, String hashedPassword, String emailId,
            AsyncCallback<UserData> cb) {
        proxy.regUserToAssocOpenIdWithEncrption(name, hashedPassword, emailId, cb);
    }

    public void checkIfUserAuthenticatedToAssocOpenId(AsyncCallback<String> cb) {
