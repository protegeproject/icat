...
public class ICDCategoryTitle2IDMap extends EntityTitle2IDMap {


	private static final long serialVersionUID = 5090953870850475907L;

	public ICDCategoryTitle2IDMap(ICDContentModel cm, boolean buildFullMap) {
		super(cm, buildFullMap);
	}

	public ICDCategoryTitle2IDMap(EntityID2TitlesMap id2titlesMap) {
		super(id2titlesMap);
	}
