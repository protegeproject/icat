...
public interface OntologyServiceAsync {
    ...
    void createClsWithProperty(String projectName, String clsName, String superClsName, String propertyName, String propertyValue, String user, String operationDescription,
            AsyncCallback<EntityData> cb);
