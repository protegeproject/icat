    ...
    private KnowledgeBaseListener createKBListener() {
        kbListener = new KnowledgeBaseAdapter() {
            ...
            public void clsCreated(KnowledgeBaseEvent event) {
                ...
                events.add(createEvent(event, EventType.CLASS_CREATED, getEntityDataList(event.getCls()
            ...
            public void slotCreated(KnowledgeBaseEvent event) {
                ...
                events.add(createEvent(event, EventType.PROPERTY_CREATED, getEntityDataList(event.getSlot()
                        .getDirectSuperslots())));
            }
            ...
            public void clsDeleted(KnowledgeBaseEvent event) {
                ...
                events.add(deleteEvent(event, EventType.CLASS_DELETED, getEntityDataList(event.getCls()
                        .getDirectSuperclasses())));
            }
            ...
            public void slotDeleted(KnowledgeBaseEvent event) {
                ...
                events.add(deleteEvent(event, EventType.PROPERTY_DELETED, getEntityDataList(event.getSlot()
                        .getDirectSuperslots())));
            }
    ...
    private ClsListener createClsListener() {
        clsListener = new ClsAdapter() {
            ...
            public void directSubclassRemoved(ClsEvent event) {
                ...
                events.add(createEvent(event, EventType.SUBCLASS_REMOVED, getEntityDataList(CollectionUtilities
                        .createCollection(event.getSubclass())))); //3rd arg - the subclass
            }
            ...
            public void directSubclassAdded(ClsEvent event) {
                ...
                events.add(createEvent(event, EventType.SUBCLASS_ADDED, getSubclassEntityDataList(CollectionUtilities
                        .createCollection(event.getSubclass()), true)));
            }
        };
        return clsListener;
    }
        ...
        for (Object o : clses) {
            if (o instanceof Cls) {
                ...
                SubclassEntityData subclassEntityData = new SubclassEntityData(subcls.getName(),
                        OntologyServiceImpl.getBrowserText(subcls), null, subcls.getVisibleDirectSubclassCount());
