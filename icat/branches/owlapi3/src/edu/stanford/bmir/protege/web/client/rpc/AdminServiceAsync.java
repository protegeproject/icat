...
public interface AdminServiceAsync {
    ...
    void isLoginWithHttps(AsyncCallback<Boolean> callback);

    void isAuthenticateWithOpenId(AsyncCallback<Boolean> callback);

    void getApplicationHttpsPort(AsyncCallback<String> callback);

    void getServerPollingTimeoutMin(AsyncCallback<Integer> callback);
