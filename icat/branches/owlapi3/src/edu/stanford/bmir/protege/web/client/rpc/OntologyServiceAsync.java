...
public interface OntologyServiceAsync {
    ...
    void moveCls(String projectName, String clsName, String oldParentName, String newParentName, String user,
            String operationDescription, AsyncCallback<Void> cb);
    ...
    void getAllImplementedClasses(String projectName, EntityData data, AsyncCallback<List<EntityData>> cb);

    void getObjectProperties(String projectName, String entityName, AsyncCallback<ArrayList> async);

    void getDatatypeProperties(String projectName, String entityName, AsyncCallback<ArrayList> async);
}
