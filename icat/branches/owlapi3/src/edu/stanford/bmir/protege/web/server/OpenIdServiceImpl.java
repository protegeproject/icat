...
public class OpenIdServiceImpl extends RemoteServiceServlet implements OpenIdService {
    ...
    /* Returns whether WebProtege Authentication with OpenId is allowed or not.
     * (non-Javadoc)
     * @see edu.stanford.bmir.protege.web.client.rpc.OpenIdService#shouldWebProtegeAuthenticateWithOpenId()
     */
