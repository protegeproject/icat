...
public class ChAOServiceManager {
    ...
    public void getChangesByDescription(String projectName, String entityName, String filterString, int start, int limit,
            String sort, String dir, AsyncCallback<PaginationData<ChangeData>> callback){
        proxy.getChangesByDescription(projectName, entityName, filterString, start, limit, sort, dir, callback);
    }
    
    public void getChangesByAuthor(String projectName, String entityName, String filterString, int start, int limit, String sort,
            String dir, AsyncCallback<PaginationData<ChangeData>> callback){
        proxy.getChangesByAuthor(projectName, entityName, filterString, start, limit, sort, dir, callback);
    }
    
    public void getChangesByDate(String projectName, String entityName, Date fromDate, Date toDate, int start, int limit, String sort,
            String dir, AsyncCallback<PaginationData<ChangeData>> callback){
        proxy.getChangesByDate(projectName, entityName, fromDate, toDate, start, limit, sort, dir, callback);
    }
