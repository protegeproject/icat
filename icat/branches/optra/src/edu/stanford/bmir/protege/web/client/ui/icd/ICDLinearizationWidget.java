...
public class ICDLinearizationWidget extends InstanceGridWidget {
                ...
                if (e.getTarget(".checkbox", 1) != null) {
                    ...
                    if (record != null) {
                        if (UIUtil.confirmOperationAllowed(getProject())) {
                            ...
                            updateInstanceValue(record, colindex, value == null ? "" : value, record.getAsString(field), ValueType.Boolean);
                        }
                    }
    ...
    protected void updateInstanceValue(Record record, int colIndex, Object oldValue, Object newValue, ValueType valueType) {
        ...
        if (selSubject != null) {
            ...
            Object newValueId = (newValue == null ? "" : newValue);
            newValueId = (newValueId instanceof EntityData) ? ((EntityData)newValueId).getName() : newValueId.toString();
                    ...
                    if (currentRecord != null) {
                        ...
                        if (colIndexParent >= 0) { //this col is wrong
                          //  int colIndex = getGridPanel().getColumnModel().getColumnCount() + OFFSET_PARENT_ENTITY_COLUMN - OFFSET_MAX_COLUMN - 1; //TT: not sure this works
                            updateInstanceValue(currentRecord, colIndexParent, oldValue, firstSelectedParent, ValueType.Instance);
                        }
                    }
