...
import edu.stanford.bmir.protege.web.client.model.listener.ShareOntolotyAccessListenerAdapter;
...
public class TopPanel extends Panel {
    ...
    public TopPanel() {
        ...
        ShareOntologyAccessEventManager.getShareOntologyAccessManager().addShareLinkVisibilityListener(
                new ShareOntolotyAccessListenerAdapter() {
    ...
    protected HTML getSignInOutHtml() {
        signInOutHtml = new HTML("<a id='login' href='javascript:;'><span style='font-size:75%; text-decoration:underline;'>"
    ...
    protected HorizontalPanel getShareLinkPanel() {
        shareHtml = new HTML("<a id='share' href='javascript:;'><span style='font-size:75%; text-decoration:underline;'>"
                + "Share" + "</span></a>");
        shareHtml.addClickHandler(new ClickHandler() {
            public void onClick(ClickEvent event) {

                if (accessPolicyUtil == null) {
                    accessPolicyUtil = new AccessPolicyUtil();
                }
                accessPolicyUtil.displayShareAccessWindow(currentSelectedProject);
            }
        });
    ...
    private void adjustUserNameText() {
        signInOutHtml.setHTML("<a id='login' href='javascript:;'><span style='font-size:75%; text-decoration:underline;'>"
