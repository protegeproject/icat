...
public interface AuthenticateServiceAsync {
    ...
    void isAuthenticateWithOpenId(AsyncCallback<Boolean> callback);
    ...
    void addFacebookUserDetailsToSession(String provider, String profileUrl, String userId,String loginMethod,  AsyncCallback<Boolean> callback);
