...
public class ParsableOWLOntologyFactory extends AbstractInMemOWLOntologyFactory {
    ...
    public synchronized OWLOntology loadOWLOntology(OWLOntologyDocumentSource documentSource, final OWLOntologyCreationHandler mediator) throws OWLOntologyCreationException {
