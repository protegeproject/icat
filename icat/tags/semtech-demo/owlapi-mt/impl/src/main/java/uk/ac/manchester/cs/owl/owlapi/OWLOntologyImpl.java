 ...
 * @
 */
public class OWLOntologyImpl extends OWLObjectImpl implements OWLOntology {
    ...
    //	No change after object creation
    ...
    //
    //	They do not change after the objects are created, they meet the definition of final
    //
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    /***************************************************************************
     * 	The following set of variables are caches for the values above and are
     * 	calculated as needed. For that reason, they change after the class objects
     * 	have been created and have to be volatile, so this changes can be propagated
     * 	to other threads as soon as they are made.
     ****************************************************************************/
    ...
    private volatile Map<OWLClass, Set<OWLClassAxiom>> classAxiomsByClass = null; // Build lazily

    private volatile Map<OWLClass, Set<OWLSubClassOfAxiom>> subClassAxiomsByLHS = null; // Build lazily

    private volatile Map<OWLClass, Set<OWLSubClassOfAxiom>> subClassAxiomsByRHS = null; // Build lazily

    private volatile Map<OWLClass, Set<OWLEquivalentClassesAxiom>> equivalentClassesAxiomsByClass = null; // Build lazily

    private volatile Map<OWLClass, Set<OWLDisjointClassesAxiom>> disjointClassesAxiomsByClass = null; // Build lazily

    private volatile Map<OWLClass, Set<OWLDisjointUnionAxiom>> disjointUnionAxiomsByClass = null; // Build lazily

    private volatile Map<OWLClass, Set<OWLHasKeyAxiom>> hasKeyAxiomsByClass = null; // Build lazily
    ...
    private volatile Map<OWLObjectPropertyExpression, Set<OWLSubObjectPropertyOfAxiom>> objectSubPropertyAxiomsByLHS = null; // Build lazily

    private volatile Map<OWLObjectPropertyExpression, Set<OWLSubObjectPropertyOfAxiom>> objectSubPropertyAxiomsByRHS = null; // Build lazily

    private volatile Map<OWLObjectPropertyExpression, Set<OWLEquivalentObjectPropertiesAxiom>> equivalentObjectPropertyAxiomsByProperty = null; // Build lazily

    private volatile Map<OWLObjectPropertyExpression, Set<OWLDisjointObjectPropertiesAxiom>> disjointObjectPropertyAxiomsByProperty = null; // Build lazily

    private volatile Map<OWLObjectPropertyExpression, Set<OWLObjectPropertyDomainAxiom>> objectPropertyDomainAxiomsByProperty = null; // Build lazily

    private volatile Map<OWLObjectPropertyExpression, Set<OWLObjectPropertyRangeAxiom>> objectPropertyRangeAxiomsByProperty = null; // Build lazily

    private volatile Map<OWLObjectPropertyExpression, Set<OWLFunctionalObjectPropertyAxiom>> functionalObjectPropertyAxiomsByProperty = null; // Build lazily

    private volatile Map<OWLObjectPropertyExpression, Set<OWLInverseFunctionalObjectPropertyAxiom>> inverseFunctionalPropertyAxiomsByProperty = null; // Build lazily

    private volatile Map<OWLObjectPropertyExpression, Set<OWLSymmetricObjectPropertyAxiom>> symmetricPropertyAxiomsByProperty = null; // Build lazily

    private volatile Map<OWLObjectPropertyExpression, Set<OWLAsymmetricObjectPropertyAxiom>> asymmetricPropertyAxiomsByProperty = null; // Build lazily

    private volatile Map<OWLObjectPropertyExpression, Set<OWLReflexiveObjectPropertyAxiom>> reflexivePropertyAxiomsByProperty = null; // Build lazily

    private volatile Map<OWLObjectPropertyExpression, Set<OWLIrreflexiveObjectPropertyAxiom>> irreflexivePropertyAxiomsByProperty = null; // Build lazily

    private volatile Map<OWLObjectPropertyExpression, Set<OWLTransitiveObjectPropertyAxiom>> transitivePropertyAxiomsByProperty = null; // Build lazily

    private volatile Map<OWLObjectPropertyExpression, Set<OWLInverseObjectPropertiesAxiom>> inversePropertyAxiomsByProperty = null; // Build lazily
    ...
    private volatile Map<OWLDataPropertyExpression, Set<OWLSubDataPropertyOfAxiom>> dataSubPropertyAxiomsByLHS = null; // Build lazily

    private volatile Map<OWLDataPropertyExpression, Set<OWLSubDataPropertyOfAxiom>> dataSubPropertyAxiomsByRHS = null; // Build lazily

    private volatile Map<OWLDataPropertyExpression, Set<OWLEquivalentDataPropertiesAxiom>> equivalentDataPropertyAxiomsByProperty = null; // Build lazily

    private volatile Map<OWLDataPropertyExpression, Set<OWLDisjointDataPropertiesAxiom>> disjointDataPropertyAxiomsByProperty = null; // Build lazily

    private volatile Map<OWLDataPropertyExpression, Set<OWLDataPropertyDomainAxiom>> dataPropertyDomainAxiomsByProperty = null; // Build lazily

    private volatile Map<OWLDataPropertyExpression, Set<OWLDataPropertyRangeAxiom>> dataPropertyRangeAxiomsByProperty = null; // Build lazily

    private volatile Map<OWLDataPropertyExpression, Set<OWLFunctionalDataPropertyAxiom>> functionalDataPropertyAxiomsByProperty = null; // Build lazily
    ...
    private volatile Map<OWLIndividual, Set<OWLClassAssertionAxiom>> classAssertionAxiomsByIndividual = null; // Build lazily

    private volatile Map<OWLClass, Set<OWLClassAssertionAxiom>> classAssertionAxiomsByClass = null; // Build lazily

    private volatile Map<OWLIndividual, Set<OWLObjectPropertyAssertionAxiom>> objectPropertyAssertionsByIndividual = null; // Build lazily

    private volatile Map<OWLIndividual, Set<OWLDataPropertyAssertionAxiom>> dataPropertyAssertionsByIndividual = null; // Build lazily

    private volatile Map<OWLIndividual, Set<OWLNegativeObjectPropertyAssertionAxiom>> negativeObjectPropertyAssertionAxiomsByIndividual = null; // Build lazily

    private volatile Map<OWLIndividual, Set<OWLNegativeDataPropertyAssertionAxiom>> negativeDataPropertyAssertionAxiomsByIndividual = null; // Build lazily

    private volatile Map<OWLIndividual, Set<OWLDifferentIndividualsAxiom>> differentIndividualsAxiomsByIndividual = null; // Build lazily

    private volatile Map<OWLIndividual, Set<OWLSameIndividualAxiom>> sameIndividualsAxiomsByIndividual = null; // Build lazily

    private volatile Map<OWLAnnotationSubject, Set<OWLAnnotationAssertionAxiom>> annotationAssertionAxiomsBySubject = null; // Build lazily
...
//    private Map<IRI, Set<OWLAnnotationAxiom>> annotationAxiomsByAnnotationURI = createMap();
    ...
    private volatile OWLEntityReferenceChecker entityReferenceChecker = new OWLEntityReferenceChecker();
    
    private volatile OWLMutableOntologyImpl mutableOnto;

    OWLOntologyImpl(OWLOntologyImpl onto, OWLMutableOntologyImpl mutableOnto, List<? extends OWLOntologyChange> changes, List<OWLOntologyChange> changed){
    	super(onto.manager.getOWLDataFactory());
    	manager= onto.manager;
    	
    	// TODO bad solution
    	this.mutableOnto= mutableOnto;
    	
//    	//	Only copies from mutable objects need to be synchronized
//    	if (onto instanceof OWLMutableOntology) 
//    		synchronized (onto) {
//    			setContent(onto);
//    		}
//    	else
    	...
    	//	Add changes
    	//	Do I really want to do that? Why 2 separate methods?
    	if (changes==null || changes.size()==0) return;
    	if (changed==null) changed= new ArrayList<OWLOntologyChange>();
        if (changes.size()==1)
        	changed.addAll(doChange(changes.get(0)));
        else
        	changed.addAll(doChanges(changes));
    }
    
    private void setContent(OWLOntologyImpl onto){
    	ontologyID= onto.ontologyID;

    	//
    	// Sets of different kinds of axioms
    	//
    	importsDeclarations = onto.importsDeclarations;
    	ontologyAnnotations = onto.ontologyAnnotations;
    	axiomsByType = onto.axiomsByType;
    	logicalAxiom2AnnotatedAxiomMap = onto.logicalAxiom2AnnotatedAxiomMap;
    	generalClassAxioms = onto.generalClassAxioms;
    	propertyChainSubPropertyAxioms = onto.propertyChainSubPropertyAxioms;
    	//
    	// Referenced entities counts
    	//
    	owlClassReferences = onto.owlClassReferences;
    	owlObjectPropertyReferences = onto.owlObjectPropertyReferences;
    	owlDataPropertyReferences = onto.owlDataPropertyReferences;
    	owlIndividualReferences = onto.owlIndividualReferences;
    	owlAnonymousIndividualReferences = onto.owlAnonymousIndividualReferences;
    	owlDatatypeReferences = onto.owlDatatypeReferences;
    	owlAnnotationPropertyReferences = onto.owlAnnotationPropertyReferences;
    	//
    	// OWLClassAxioms by OWLClass
    	//
    	classAxiomsByClass = onto.classAxiomsByClass;
    	subClassAxiomsByLHS = onto.subClassAxiomsByLHS;
    	subClassAxiomsByRHS = onto.subClassAxiomsByRHS;
    	equivalentClassesAxiomsByClass = onto.equivalentClassesAxiomsByClass;
    	disjointClassesAxiomsByClass = onto.disjointClassesAxiomsByClass;
    	disjointUnionAxiomsByClass = onto.disjointUnionAxiomsByClass;
    	hasKeyAxiomsByClass = onto.hasKeyAxiomsByClass;
    	//
    	// OWLObjectPropertyAxioms by OWLObjectProperty
    	//
    	objectSubPropertyAxiomsByLHS = onto.objectSubPropertyAxiomsByLHS;
    	objectSubPropertyAxiomsByRHS = onto.objectSubPropertyAxiomsByRHS;
    	equivalentObjectPropertyAxiomsByProperty = onto.equivalentObjectPropertyAxiomsByProperty;
    	disjointObjectPropertyAxiomsByProperty = onto.disjointObjectPropertyAxiomsByProperty;
    	objectPropertyDomainAxiomsByProperty = onto.objectPropertyDomainAxiomsByProperty;
    	objectPropertyRangeAxiomsByProperty = onto.objectPropertyRangeAxiomsByProperty;
    	functionalObjectPropertyAxiomsByProperty = onto.functionalObjectPropertyAxiomsByProperty;
    	inverseFunctionalPropertyAxiomsByProperty = onto.inverseFunctionalPropertyAxiomsByProperty;
    	symmetricPropertyAxiomsByProperty = onto.symmetricPropertyAxiomsByProperty;
    	asymmetricPropertyAxiomsByProperty = onto.asymmetricPropertyAxiomsByProperty;
    	reflexivePropertyAxiomsByProperty = onto.reflexivePropertyAxiomsByProperty;
    	irreflexivePropertyAxiomsByProperty = onto.irreflexivePropertyAxiomsByProperty;
    	transitivePropertyAxiomsByProperty = onto.transitivePropertyAxiomsByProperty;
    	inversePropertyAxiomsByProperty = onto.inversePropertyAxiomsByProperty;
    	//
    	// OWLDataPropertyAxioms by OWLDataProperty
    	//
    	dataSubPropertyAxiomsByLHS = onto.dataSubPropertyAxiomsByLHS;
    	dataSubPropertyAxiomsByRHS = onto.dataSubPropertyAxiomsByLHS;
    	equivalentDataPropertyAxiomsByProperty = onto.equivalentDataPropertyAxiomsByProperty;
    	disjointDataPropertyAxiomsByProperty = onto.disjointDataPropertyAxiomsByProperty;
    	dataPropertyDomainAxiomsByProperty = onto.dataPropertyDomainAxiomsByProperty;
    	dataPropertyRangeAxiomsByProperty = onto.dataPropertyRangeAxiomsByProperty;
    	functionalDataPropertyAxiomsByProperty = onto.functionalDataPropertyAxiomsByProperty;
    	//
    	// OWLIndividualAxioms by OWLIndividual
    	//
    	classAssertionAxiomsByIndividual = onto.classAssertionAxiomsByIndividual;
    	classAssertionAxiomsByClass = onto.classAssertionAxiomsByClass;
    	objectPropertyAssertionsByIndividual = onto.objectPropertyAssertionsByIndividual;
    	dataPropertyAssertionsByIndividual = onto.dataPropertyAssertionsByIndividual;
    	negativeObjectPropertyAssertionAxiomsByIndividual = onto.negativeObjectPropertyAssertionAxiomsByIndividual;
    	negativeDataPropertyAssertionAxiomsByIndividual = onto.negativeDataPropertyAssertionAxiomsByIndividual;
    	differentIndividualsAxiomsByIndividual = onto.differentIndividualsAxiomsByIndividual;
    	sameIndividualsAxiomsByIndividual = onto.sameIndividualsAxiomsByIndividual;
    	annotationAssertionAxiomsBySubject = onto.annotationAssertionAxiomsBySubject;
    	//
    	// Annotations
    	//
    	//        private Map<IRI, Set<OWLAnnotationAxiom>> annotationAxiomsByAnnotationURI = createMap();
    	entityReferenceChecker = onto.entityReferenceChecker;
    }
...
//        return (Set<T>) getAxioms(axiomType, axiomsByType, false);
        return (Set<T>) getAxiomsGen(axiomType, axiomsByType);
    }
    ...
    public <T extends OWLAxiom> Set<T> getAxioms(AxiomType<T> axiomType, boolean includeImportsClosure) {
        ...
        for(OWLOntology ont : getImportsClosure()) {
            result.addAll(ont.getAxioms(axiomType));		//TODO 
        }
        return result;
    }
...
//        return (Set<T>) getAxioms(axiomType, axiomsByType, false);
    ...
    public Set<OWLAnnotation> getAnnotations() {
        return getReturnSet(ontologyAnnotations);		//TODO check
    }
...
//            return getAxioms(owlEntity.asOWLAnnotationProperty(), owlAnnotationPropertyReferences, false);
            return getAxiomsGen(owlEntity.asOWLAnnotationProperty(), owlAnnotationPropertyReferences);
        }
        return Collections.emptySet();
    }
...
//        return getAxioms(individual, owlAnonymousIndividualReferences, false);
        return getAxiomsGen(individual, owlAnonymousIndividualReferences);
    }
    ...
    public Set<OWLOntology> getImports() throws UnknownOWLOntologyException {
        return manager.getImports(mutableOnto);
    }
    ...
    public Set<OWLOntology> getDirectImports() throws UnknownOWLOntologyException {
        return manager.getDirectImports(mutableOnto);
    }
    
    public Set<OWLOntology> getImportsClosure() throws UnknownOWLOntologyException {
        return getOWLOntologyManager().getImportsClosure(mutableOnto);
    }
...
//                    addToIndexedSet(axiom.getSubClass().asOWLClass(), subClassAxiomsByLHS, axiom);
                	subClassAxiomsByLHS= addToIndexedSet(axiom.getSubClass().asOWLClass(), subClassAxiomsByLHS, axiom);
                }
            }
...
//                    addToIndexedSet(axiom.getSuperClass().asOWLClass(), subClassAxiomsByRHS, axiom);
                	subClassAxiomsByRHS= addToIndexedSet(axiom.getSuperClass().asOWLClass(), subClassAxiomsByRHS, axiom);
                }
            }
...
//                        addToIndexedSet(desc.asOWLClass(), equivalentClassesAxiomsByClass, axiom);
                    	equivalentClassesAxiomsByClass= addToIndexedSet(desc.asOWLClass(), equivalentClassesAxiomsByClass, axiom);
                    }
                }
            }
...
//                        addToIndexedSet(desc.asOWLClass(), disjointClassesAxiomsByClass, axiom);
                    	disjointClassesAxiomsByClass= addToIndexedSet(desc.asOWLClass(), disjointClassesAxiomsByClass, axiom);
                    }
                }
            }
...
//                        addToIndexedSet(desc.asOWLClass(), disjointUnionAxiomsByClass, axiom);
                    	disjointUnionAxiomsByClass= addToIndexedSet(desc.asOWLClass(), disjointUnionAxiomsByClass, axiom);
                    }
                }
            }
...
//                    addToIndexedSet(axiom.getClassExpression().asOWLClass(), hasKeyAxiomsByClass, axiom);
                	hasKeyAxiomsByClass= addToIndexedSet(axiom.getClassExpression().asOWLClass(), hasKeyAxiomsByClass, axiom);
                }
            }
...
//                addToIndexedSet(axiom.getSubProperty(), objectSubPropertyAxiomsByLHS, axiom);
            	objectSubPropertyAxiomsByLHS= addToIndexedSet(axiom.getSubProperty(), objectSubPropertyAxiomsByLHS, axiom);
            }
...
//                addToIndexedSet(axiom.getSuperProperty(), objectSubPropertyAxiomsByRHS, axiom);
            	objectSubPropertyAxiomsByRHS= addToIndexedSet(axiom.getSuperProperty(), objectSubPropertyAxiomsByRHS, axiom);
            }
...
//                addToIndexedSet(axiom.getProperty(), objectPropertyDomainAxiomsByProperty, axiom);
            	objectPropertyDomainAxiomsByProperty= addToIndexedSet(axiom.getProperty(), objectPropertyDomainAxiomsByProperty, axiom);
            }
...
//                addToIndexedSet(axiom.getProperty(), objectPropertyRangeAxiomsByProperty, axiom);
            	objectPropertyRangeAxiomsByProperty= addToIndexedSet(axiom.getProperty(), objectPropertyRangeAxiomsByProperty, axiom);
            }
...
//                    addToIndexedSet(prop, inversePropertyAxiomsByProperty, axiom);
                	inversePropertyAxiomsByProperty= addToIndexedSet(prop, inversePropertyAxiomsByProperty, axiom);
                }
            }
...
//                    addToIndexedSet(prop, equivalentObjectPropertyAxiomsByProperty, axiom);
                	equivalentObjectPropertyAxiomsByProperty= addToIndexedSet(prop, equivalentObjectPropertyAxiomsByProperty, axiom);
                }
            }
...
//                    addToIndexedSet(prop, disjointObjectPropertyAxiomsByProperty, axiom);
                	disjointObjectPropertyAxiomsByProperty= addToIndexedSet(prop, disjointObjectPropertyAxiomsByProperty, axiom);
                }
            }
...
//            addToIndexedSet(ax.getProperty(), map, ax);
        	map= addToIndexedSet(ax.getProperty(), map, ax);
        }
        return map;
    }
...
//                addToIndexedSet(ax.getProperty(), functionalDataPropertyAxiomsByProperty, ax);
            	functionalDataPropertyAxiomsByProperty= addToIndexedSet(ax.getProperty(), functionalDataPropertyAxiomsByProperty, ax);
            }
...
//                addToIndexedSet(axiom.getSubProperty(), dataSubPropertyAxiomsByLHS, axiom);
            	dataSubPropertyAxiomsByLHS= addToIndexedSet(axiom.getSubProperty(), dataSubPropertyAxiomsByLHS, axiom);
            }
...
//                addToIndexedSet(axiom.getSuperProperty(), dataSubPropertyAxiomsByRHS, axiom);
            	dataSubPropertyAxiomsByRHS= addToIndexedSet(axiom.getSuperProperty(), dataSubPropertyAxiomsByRHS, axiom);
            }
...
//                addToIndexedSet(axiom.getProperty(), dataPropertyDomainAxiomsByProperty, axiom);
            	dataPropertyDomainAxiomsByProperty= addToIndexedSet(axiom.getProperty(), dataPropertyDomainAxiomsByProperty, axiom);
            }
...
//                addToIndexedSet(axiom.getProperty(), dataPropertyRangeAxiomsByProperty, axiom);
            	dataPropertyRangeAxiomsByProperty= addToIndexedSet(axiom.getProperty(), dataPropertyRangeAxiomsByProperty, axiom);
            }
...
//                    addToIndexedSet(prop, equivalentDataPropertyAxiomsByProperty, axiom);
                	equivalentDataPropertyAxiomsByProperty= addToIndexedSet(prop, equivalentDataPropertyAxiomsByProperty, axiom);
                }
            }
...
//                    addToIndexedSet(prop, disjointDataPropertyAxiomsByProperty, axiom);
                	disjointDataPropertyAxiomsByProperty= addToIndexedSet(prop, disjointDataPropertyAxiomsByProperty, axiom);
                }
            }
...
//                addToIndexedSet(axiom.getIndividual(), classAssertionAxiomsByIndividual, axiom);
            	classAssertionAxiomsByIndividual= addToIndexedSet(axiom.getIndividual(), classAssertionAxiomsByIndividual, axiom);
            }
...
//                    addToIndexedSet((OWLClass) axiom.getClassExpression(), classAssertionAxiomsByClass, axiom);
                	classAssertionAxiomsByClass= addToIndexedSet((OWLClass) axiom.getClassExpression(), classAssertionAxiomsByClass, axiom);
                }
            }
...
//                addToIndexedSet(axiom.getSubject(), dataPropertyAssertionsByIndividual, axiom);
            	dataPropertyAssertionsByIndividual= addToIndexedSet(axiom.getSubject(), dataPropertyAssertionsByIndividual, axiom);
            }
...
//                addToIndexedSet(axiom.getSubject(), objectPropertyAssertionsByIndividual, axiom);
            	objectPropertyAssertionsByIndividual= addToIndexedSet(axiom.getSubject(), objectPropertyAssertionsByIndividual, axiom);
            }
...
//                addToIndexedSet(axiom.getSubject(), negativeObjectPropertyAssertionAxiomsByIndividual, axiom);
            	negativeObjectPropertyAssertionAxiomsByIndividual= addToIndexedSet(axiom.getSubject(), negativeObjectPropertyAssertionAxiomsByIndividual, axiom);
            }
...
//                addToIndexedSet(axiom.getSubject(), negativeDataPropertyAssertionAxiomsByIndividual, axiom);
            	negativeDataPropertyAssertionAxiomsByIndividual= addToIndexedSet(axiom.getSubject(), negativeDataPropertyAssertionAxiomsByIndividual, axiom);
            }
...
//                    addToIndexedSet(ind, sameIndividualsAxiomsByIndividual, axiom);
                	sameIndividualsAxiomsByIndividual= addToIndexedSet(ind, sameIndividualsAxiomsByIndividual, axiom);
                }
            }
...
//                    addToIndexedSet(ind, differentIndividualsAxiomsByIndividual, axiom);
                	differentIndividualsAxiomsByIndividual= addToIndexedSet(ind, differentIndividualsAxiomsByIndividual, axiom);
                }
            }
    ...
    //	No change after object creation
    private final ChangeAxiomVisitor changeVisitor = new ChangeAxiomVisitor();

    //	No change after object creation
    private final OWLOntologyChangeFilter changeFilter = new OWLOntologyChangeFilter();

//    public List<OWLOntologyChange> applyChange(OWLOntologyChange change) {
    private List<OWLOntologyChange> doChange(OWLOntologyChange change) {
...
//    public List<OWLOntologyChange> applyChanges(List<OWLOntologyChange> changes) {
    private List<OWLOntologyChange> doChanges(List<? extends OWLOntologyChange> changes) {
...
//    /*
//     * Should I change it to a real copy? Does it make any difference?
//     * return  new OWLOntologyImpl(this, null, null))
//     */
//    public OWLOntology immutableCopy(){
//    	return this;
//    }
//    
//
//    public OWLOntology immutableCopyWithChanges(List<? extends OWLOntologyChange> changes){
//    	return new OWLOntologyImpl(this, changes, null);
//    }
//    
//    public OWLOntology immutableCopytWithChanges(List<? extends OWLOntologyChange> changes, List<OWLOntologyChange> changed){
//    	return new OWLOntologyImpl(this, changes, changed);
//    }
...
//                importsDeclarations.add(change.getImportDeclaration());
                importsDeclarations= addToSet(importsDeclarations, change.getImportDeclaration());
            }
        }
...
//                importsDeclarations.remove(change.getImportDeclaration());
                importsDeclarations= remFromSet(importsDeclarations, change.getImportDeclaration());
            }
        }
...
//            if(ontologyAnnotations.add(change.getAnnotation())) {
            if(!ontologyAnnotations.contains(change.getAnnotation())) {
                ontologyAnnotations= addToSet(ontologyAnnotations, change.getAnnotation());
                appliedChanges.add(change);
            }
        }
 ...
 //           if(ontologyAnnotations.remove(change.getAnnotation())) {
            if(ontologyAnnotations.contains(change.getAnnotation())) {
          	    ontologyAnnotations= remFromSet(ontologyAnnotations, change.getAnnotation());
                appliedChanges.add(change);
            }
        }
    }
    ...
    //	No change after object creation
    private final OWLEntityCollector entityCollector = new OWLEntityCollector();

    //	No change after object creation
    private final OWLNamedObjectReferenceAdder referenceAdder = new OWLNamedObjectReferenceAdder();
...
//            addToIndexedSet(ind, owlAnonymousIndividualReferences, axiom);
        	owlAnonymousIndividualReferences= addToIndexedSet(ind, owlAnonymousIndividualReferences, axiom);
        }
        if(axiom.isAnnotated()) {
//            addToIndexedSet(axiom.getAxiomWithoutAnnotations(), logicalAxiom2AnnotatedAxiomMap, axiom);
            logicalAxiom2AnnotatedAxiomMap= addToIndexedSet(axiom.getAxiomWithoutAnnotations(), logicalAxiom2AnnotatedAxiomMap, axiom);
        }
    }


    //	No change after object creation
    private final OWLNamedObjectReferenceRemover referenceRemover = new OWLNamedObjectReferenceRemover();
...
//            removeAxiomFromSet(ind, owlAnonymousIndividualReferences, axiom, true);
        	owlAnonymousIndividualReferences= removeAxiomFromSet(ind, owlAnonymousIndividualReferences, axiom, true);
        }
        if(axiom.isAnnotated()) {
//            removeAxiomFromSet(axiom.getAxiomWithoutAnnotations(), logicalAxiom2AnnotatedAxiomMap, axiom, true);
        	logicalAxiom2AnnotatedAxiomMap= removeAxiomFromSet(axiom.getAxiomWithoutAnnotations(), logicalAxiom2AnnotatedAxiomMap, axiom, true);
        }
    }
...
//            addToIndexedSet(owlClass, owlClassReferences, axiom);
        	owlClassReferences= addToIndexedSet(owlClass, owlClassReferences, axiom);
        }


        public void visit(OWLObjectProperty property) {
//            addToIndexedSet(property, owlObjectPropertyReferences, axiom);
        	owlObjectPropertyReferences= addToIndexedSet(property, owlObjectPropertyReferences, axiom);
        }


        public void visit(OWLDataProperty property) {
//            addToIndexedSet(property, owlDataPropertyReferences, axiom);
        	owlDataPropertyReferences= addToIndexedSet(property, owlDataPropertyReferences, axiom);
        }


        public void visit(OWLNamedIndividual owlIndividual) {
//            addToIndexedSet(owlIndividual, owlIndividualReferences, axiom);
        	owlIndividualReferences= addToIndexedSet(owlIndividual, owlIndividualReferences, axiom);
        }

        public void visit(OWLAnnotationProperty property) {
//            addToIndexedSet(property, owlAnnotationPropertyReferences, axiom);
        	owlAnnotationPropertyReferences= addToIndexedSet(property, owlAnnotationPropertyReferences, axiom);
        }

        public void visit(OWLDatatype datatype) {
//            addToIndexedSet(datatype, owlDatatypeReferences, axiom);
        	owlDatatypeReferences= addToIndexedSet(datatype, owlDatatypeReferences, axiom);
        }
    }
...
//            removeAxiomFromSet(owlClass, owlClassReferences, axiom, true);
        	owlClassReferences= removeAxiomFromSet(owlClass, owlClassReferences, axiom, true);
        }


        public void visit(OWLObjectProperty property) {
//            removeAxiomFromSet(property, owlObjectPropertyReferences, axiom, true);
        	owlObjectPropertyReferences= removeAxiomFromSet(property, owlObjectPropertyReferences, axiom, true);
        }


        public void visit(OWLDataProperty property) {
//            removeAxiomFromSet(property, owlDataPropertyReferences, axiom, true);
        	owlDataPropertyReferences= removeAxiomFromSet(property, owlDataPropertyReferences, axiom, true);
        }


        public void visit(OWLNamedIndividual owlIndividual) {
//            removeAxiomFromSet(owlIndividual, owlIndividualReferences, axiom, true);
        	owlIndividualReferences= removeAxiomFromSet(owlIndividual, owlIndividualReferences, axiom, true);
        }

        public void visit(OWLAnnotationProperty property) {
//            removeAxiomFromSet(property, owlAnnotationPropertyReferences, axiom, true);
        	owlAnnotationPropertyReferences= removeAxiomFromSet(property, owlAnnotationPropertyReferences, axiom, true);
        }

        public void visit(OWLDatatype datatype) {
//            removeAxiomFromSet(datatype, owlDatatypeReferences, axiom, true);
        	owlDatatypeReferences= removeAxiomFromSet(datatype, owlDatatypeReferences, axiom, true);
        }
    }
...
//                addToIndexedSet(SUBCLASS_OF, axiomsByType, axiom);
            	axiomsByType= addToIndexedSet(SUBCLASS_OF, axiomsByType, axiom);
                if (!axiom.getSubClass().isAnonymous()) {
...
//                    addToIndexedSet(subClass, classAxiomsByClass, axiom);
                    subClassAxiomsByLHS= addToIndexedSet(subClass, subClassAxiomsByLHS, axiom);
                    classAxiomsByClass= addToIndexedSet(subClass, classAxiomsByClass, axiom);
                } else {
//                    generalClassAxioms.add(axiom);
                	generalClassAxioms= addToSet(generalClassAxioms, axiom);
                }
                if (!axiom.getSuperClass().isAnonymous()) {
//                    addToIndexedSet((OWLClass) axiom.getSuperClass(), subClassAxiomsByRHS, axiom);
                	subClassAxiomsByRHS= addToIndexedSet((OWLClass) axiom.getSuperClass(), subClassAxiomsByRHS, axiom);
                }
            } else {
//                removeAxiomFromSet(SUBCLASS_OF, axiomsByType, axiom, true);
            	axiomsByType= removeAxiomFromSet(SUBCLASS_OF, axiomsByType, axiom, true);
                if (!axiom.getSubClass().isAnonymous()) {
                    OWLClass subClass = (OWLClass) axiom.getSubClass();
//                    removeAxiomFromSet(subClass, subClassAxiomsByLHS, axiom, true);
//                    removeAxiomFromSet(subClass, classAxiomsByClass, axiom, true);
                    subClassAxiomsByLHS= removeAxiomFromSet(subClass, subClassAxiomsByLHS, axiom, true);
                    classAxiomsByClass= removeAxiomFromSet(subClass, classAxiomsByClass, axiom, true);
                } else {
//                    removeAxiomFromSet(axiom, generalClassAxioms);
                	generalClassAxioms= removeAxiomFromSet(axiom, generalClassAxioms);
                }
                if (!axiom.getSuperClass().isAnonymous()) {
//                    removeAxiomFromSet(axiom.getSuperClass().asOWLClass(), subClassAxiomsByRHS, axiom, true);
                	subClassAxiomsByRHS= removeAxiomFromSet(axiom.getSuperClass().asOWLClass(), subClassAxiomsByRHS, axiom, true);
                }
            }
        }
...
//                addToIndexedSet(NEGATIVE_OBJECT_PROPERTY_ASSERTION, axiomsByType, axiom);
            	negativeObjectPropertyAssertionAxiomsByIndividual= addToIndexedSet(axiom.getSubject(), negativeObjectPropertyAssertionAxiomsByIndividual, axiom);
            	axiomsByType= addToIndexedSet(NEGATIVE_OBJECT_PROPERTY_ASSERTION, axiomsByType, axiom);
            } else {
...
//                removeAxiomFromSet(axiom.getSubject(), negativeObjectPropertyAssertionAxiomsByIndividual, axiom, true);
            	axiomsByType= removeAxiomFromSet(NEGATIVE_OBJECT_PROPERTY_ASSERTION, axiomsByType, axiom, true);
            	negativeObjectPropertyAssertionAxiomsByIndividual= removeAxiomFromSet(axiom.getSubject(), negativeObjectPropertyAssertionAxiomsByIndividual, axiom, true);
            }
        }
...
//                addToIndexedSet(ASYMMETRIC_OBJECT_PROPERTY, axiomsByType, axiom);
            	asymmetricPropertyAxiomsByProperty= addToIndexedSet(axiom.getProperty(), asymmetricPropertyAxiomsByProperty, axiom);
            	axiomsByType= addToIndexedSet(ASYMMETRIC_OBJECT_PROPERTY, axiomsByType, axiom);
            } else {
...
//                removeAxiomFromSet(axiom.getProperty(), asymmetricPropertyAxiomsByProperty, axiom, true);
            	axiomsByType= removeAxiomFromSet(ASYMMETRIC_OBJECT_PROPERTY, axiomsByType, axiom, true);
            	asymmetricPropertyAxiomsByProperty= removeAxiomFromSet(axiom.getProperty(), asymmetricPropertyAxiomsByProperty, axiom, true);
            }
        }
...
//                addToIndexedSet(REFLEXIVE_OBJECT_PROPERTY, axiomsByType, axiom);
            	reflexivePropertyAxiomsByProperty= addToIndexedSet(axiom.getProperty(), reflexivePropertyAxiomsByProperty, axiom);
            	axiomsByType= addToIndexedSet(REFLEXIVE_OBJECT_PROPERTY, axiomsByType, axiom);
            } else {
...
//                removeAxiomFromSet(axiom.getProperty(), reflexivePropertyAxiomsByProperty, axiom, true);
            	axiomsByType= removeAxiomFromSet(REFLEXIVE_OBJECT_PROPERTY, axiomsByType, axiom, true);
            	reflexivePropertyAxiomsByProperty= removeAxiomFromSet(axiom.getProperty(), reflexivePropertyAxiomsByProperty, axiom, true);
            }
        }
...
//                addToIndexedSet(DISJOINT_CLASSES, axiomsByType, axiom);
            	axiomsByType= addToIndexedSet(DISJOINT_CLASSES, axiomsByType, axiom);
...
//                        addToIndexedSet(cls, classAxiomsByClass, axiom);
                        disjointClassesAxiomsByClass= addToIndexedSet(cls, disjointClassesAxiomsByClass, axiom);
                        classAxiomsByClass= addToIndexedSet(cls, classAxiomsByClass, axiom);
                        allAnon = false;
                    }
                }
                if (allAnon) {
...
//                removeAxiomFromSet(DISJOINT_CLASSES, axiomsByType, axiom, true);
            	axiomsByType= removeAxiomFromSet(DISJOINT_CLASSES, axiomsByType, axiom, true);
                boolean allAnon = true;
                for (OWLClassExpression desc : axiom.getClassExpressions()) {
                    if (!desc.isAnonymous()) {
                        OWLClass cls = (OWLClass) desc;
...
//                        removeAxiomFromSet(cls, classAxiomsByClass, axiom, true);
                        disjointClassesAxiomsByClass= removeAxiomFromSet(cls, disjointClassesAxiomsByClass, axiom, true);
                        classAxiomsByClass= removeAxiomFromSet(cls, classAxiomsByClass, axiom, true);
                        allAnon = false;
                    }
                }
                if (allAnon) {
//                    generalClassAxioms.remove(axiom);
                	generalClassAxioms= remFromSet(generalClassAxioms, axiom);
                }
            }
        }
...
//                addToIndexedSet(axiom.getProperty(), dataPropertyDomainAxiomsByProperty, axiom);
            	axiomsByType= addToIndexedSet(DATA_PROPERTY_DOMAIN, axiomsByType, axiom);
            	dataPropertyDomainAxiomsByProperty= addToIndexedSet(axiom.getProperty(), dataPropertyDomainAxiomsByProperty, axiom);
            } else {
...
//                removeAxiomFromSet(axiom.getProperty(), dataPropertyDomainAxiomsByProperty, axiom, true);
            	axiomsByType= removeAxiomFromSet(DATA_PROPERTY_DOMAIN, axiomsByType, axiom, true);
            	dataPropertyDomainAxiomsByProperty= removeAxiomFromSet(axiom.getProperty(), dataPropertyDomainAxiomsByProperty, axiom, true);
            }
        }
 ...
 //               addToIndexedSet(OBJECT_PROPERTY_DOMAIN, axiomsByType, axiom);
            	axiomsByType= addToIndexedSet(OBJECT_PROPERTY_DOMAIN, axiomsByType, axiom);
                if (axiom.getProperty() instanceof OWLObjectProperty) {
//                    addToIndexedSet(axiom.getProperty(),
//                                    objectPropertyDomainAxiomsByProperty,
//                                    axiom);
                	objectPropertyDomainAxiomsByProperty= addToIndexedSet(axiom.getProperty(),
                            objectPropertyDomainAxiomsByProperty,
                            axiom);
                }
            } else {
//                removeAxiomFromSet(OBJECT_PROPERTY_DOMAIN, axiomsByType, axiom, true);
            	axiomsByType= removeAxiomFromSet(OBJECT_PROPERTY_DOMAIN, axiomsByType, axiom, true);
                if (axiom.getProperty() instanceof OWLObjectProperty) {
//                    removeAxiomFromSet(axiom.getProperty(),
//                                       objectPropertyDomainAxiomsByProperty,
//                                       axiom,
//                                       true);
                	objectPropertyDomainAxiomsByProperty= removeAxiomFromSet(axiom.getProperty(),
                            objectPropertyDomainAxiomsByProperty,
                            axiom,
                            true);
                }
...
//                addToIndexedSet(EQUIVALENT_OBJECT_PROPERTIES, axiomsByType, axiom);
            	axiomsByType= addToIndexedSet(EQUIVALENT_OBJECT_PROPERTIES, axiomsByType, axiom);
                for (OWLObjectPropertyExpression prop : axiom.getProperties()) {
//                    addToIndexedSet(prop, equivalentObjectPropertyAxiomsByProperty, axiom);
                	equivalentObjectPropertyAxiomsByProperty= addToIndexedSet(prop, equivalentObjectPropertyAxiomsByProperty, axiom);
                }
...
//                removeAxiomFromSet(EQUIVALENT_OBJECT_PROPERTIES, axiomsByType, axiom, true);
            	axiomsByType= removeAxiomFromSet(EQUIVALENT_OBJECT_PROPERTIES, axiomsByType, axiom, true);
                for (OWLObjectPropertyExpression prop : axiom.getProperties()) {
//                    removeAxiomFromSet(prop, equivalentObjectPropertyAxiomsByProperty, axiom, true);
                	equivalentObjectPropertyAxiomsByProperty= removeAxiomFromSet(prop, equivalentObjectPropertyAxiomsByProperty, axiom, true);
                }
            }
        }
...
//                addToIndexedSet(axiom.getSecondProperty(), inversePropertyAxiomsByProperty, axiom);
            	axiomsByType= addToIndexedSet(INVERSE_OBJECT_PROPERTIES, axiomsByType, axiom);
            	inversePropertyAxiomsByProperty= addToIndexedSet(axiom.getFirstProperty(), inversePropertyAxiomsByProperty, axiom);
            	inversePropertyAxiomsByProperty= addToIndexedSet(axiom.getSecondProperty(), inversePropertyAxiomsByProperty, axiom);
            } else {
...
//                removeAxiomFromSet(axiom.getSecondProperty(), inversePropertyAxiomsByProperty, axiom, false);
            	axiomsByType= removeAxiomFromSet(INVERSE_OBJECT_PROPERTIES, axiomsByType, axiom, true);
            	inversePropertyAxiomsByProperty= removeAxiomFromSet(axiom.getFirstProperty(), inversePropertyAxiomsByProperty, axiom, false);
            	inversePropertyAxiomsByProperty= removeAxiomFromSet(axiom.getSecondProperty(), inversePropertyAxiomsByProperty, axiom, false);
            }
        }
...
//                addToIndexedSet(NEGATIVE_DATA_PROPERTY_ASSERTION, axiomsByType, axiom);
            	negativeDataPropertyAssertionAxiomsByIndividual= addToIndexedSet(axiom.getSubject(), negativeDataPropertyAssertionAxiomsByIndividual, axiom);
            	axiomsByType= addToIndexedSet(NEGATIVE_DATA_PROPERTY_ASSERTION, axiomsByType, axiom);
            } else {
...
//                removeAxiomFromSet(axiom.getSubject(), negativeDataPropertyAssertionAxiomsByIndividual, axiom, true);
            	axiomsByType= removeAxiomFromSet(NEGATIVE_DATA_PROPERTY_ASSERTION, axiomsByType, axiom, true);
            	negativeDataPropertyAssertionAxiomsByIndividual= removeAxiomFromSet(axiom.getSubject(), negativeDataPropertyAssertionAxiomsByIndividual, axiom, true);
            }
        }
...
//                    addToIndexedSet(DIFFERENT_INDIVIDUALS, axiomsByType, axiom);
                	differentIndividualsAxiomsByIndividual= addToIndexedSet(ind, differentIndividualsAxiomsByIndividual, axiom);
                	axiomsByType= addToIndexedSet(DIFFERENT_INDIVIDUALS, axiomsByType, axiom);
                }
            } else {
//                removeAxiomFromSet(DIFFERENT_INDIVIDUALS, axiomsByType, axiom, true);
            	axiomsByType= removeAxiomFromSet(DIFFERENT_INDIVIDUALS, axiomsByType, axiom, true);
                for (OWLIndividual ind : axiom.getIndividuals()) {
//                    removeAxiomFromSet(ind, differentIndividualsAxiomsByIndividual, axiom, true);
                	differentIndividualsAxiomsByIndividual= removeAxiomFromSet(ind, differentIndividualsAxiomsByIndividual, axiom, true);
                }
            }
        }
...
//                addToIndexedSet(DISJOINT_DATA_PROPERTIES, axiomsByType, axiom);
            	axiomsByType= addToIndexedSet(DISJOINT_DATA_PROPERTIES, axiomsByType, axiom);
                for (OWLDataPropertyExpression prop : axiom.getProperties()) {
//                    addToIndexedSet(prop, disjointDataPropertyAxiomsByProperty, axiom);
                	disjointDataPropertyAxiomsByProperty= addToIndexedSet(prop, disjointDataPropertyAxiomsByProperty, axiom);
                }
...
//                removeAxiomFromSet(DISJOINT_DATA_PROPERTIES, axiomsByType, axiom, true);
            	axiomsByType= removeAxiomFromSet(DISJOINT_DATA_PROPERTIES, axiomsByType, axiom, true);
                for (OWLDataPropertyExpression prop : axiom.getProperties()) {
//                    removeAxiomFromSet(prop, disjointDataPropertyAxiomsByProperty, axiom, true);
                	disjointDataPropertyAxiomsByProperty= removeAxiomFromSet(prop, disjointDataPropertyAxiomsByProperty, axiom, true);
                }
            }
        }
...
//                addToIndexedSet(DISJOINT_OBJECT_PROPERTIES, axiomsByType, axiom);
            	axiomsByType= addToIndexedSet(DISJOINT_OBJECT_PROPERTIES, axiomsByType, axiom);
                for (OWLObjectPropertyExpression prop : axiom.getProperties()) {
//                    addToIndexedSet(prop, disjointObjectPropertyAxiomsByProperty, axiom);
                	disjointObjectPropertyAxiomsByProperty= addToIndexedSet(prop, disjointObjectPropertyAxiomsByProperty, axiom);
                }
...
//                removeAxiomFromSet(DISJOINT_OBJECT_PROPERTIES, axiomsByType, axiom, true);
            	axiomsByType= removeAxiomFromSet(DISJOINT_OBJECT_PROPERTIES, axiomsByType, axiom, true);
                for (OWLObjectPropertyExpression prop : axiom.getProperties()) {
//                    removeAxiomFromSet(prop, disjointObjectPropertyAxiomsByProperty, axiom, true);
                	disjointObjectPropertyAxiomsByProperty= removeAxiomFromSet(prop, disjointObjectPropertyAxiomsByProperty, axiom, true);
                }
            }
        }
...
//                addToIndexedSet(axiom.getProperty(), objectPropertyRangeAxiomsByProperty, axiom);
            	axiomsByType= addToIndexedSet(OBJECT_PROPERTY_RANGE, axiomsByType, axiom);
            	objectPropertyRangeAxiomsByProperty= addToIndexedSet(axiom.getProperty(), objectPropertyRangeAxiomsByProperty, axiom);
            } else {
...
//                removeAxiomFromSet(axiom.getProperty(), objectPropertyRangeAxiomsByProperty, axiom, true);
            	axiomsByType= removeAxiomFromSet(OBJECT_PROPERTY_RANGE, axiomsByType, axiom, true);
            	objectPropertyRangeAxiomsByProperty= removeAxiomFromSet(axiom.getProperty(), objectPropertyRangeAxiomsByProperty, axiom, true);
            }
        }
...
//                addToIndexedSet(axiom.getSubject(), objectPropertyAssertionsByIndividual, axiom);
            	axiomsByType= addToIndexedSet(OBJECT_PROPERTY_ASSERTION, axiomsByType, axiom);
            	objectPropertyAssertionsByIndividual= addToIndexedSet(axiom.getSubject(), objectPropertyAssertionsByIndividual, axiom);
            } else {
...
//                removeAxiomFromSet(axiom.getSubject(), objectPropertyAssertionsByIndividual, axiom, true);
            	axiomsByType= removeAxiomFromSet(OBJECT_PROPERTY_ASSERTION, axiomsByType, axiom, true);
            	objectPropertyAssertionsByIndividual= removeAxiomFromSet(axiom.getSubject(), objectPropertyAssertionsByIndividual, axiom, true);
            }
        }
...
//                addToIndexedSet(axiom.getProperty(), functionalObjectPropertyAxiomsByProperty, axiom);
            	axiomsByType= addToIndexedSet(FUNCTIONAL_OBJECT_PROPERTY, axiomsByType, axiom);
            	functionalObjectPropertyAxiomsByProperty= addToIndexedSet(axiom.getProperty(), functionalObjectPropertyAxiomsByProperty, axiom);
            } else {
...
//                removeAxiomFromSet(axiom.getProperty(), functionalObjectPropertyAxiomsByProperty, axiom, true);
            	axiomsByType= removeAxiomFromSet(FUNCTIONAL_OBJECT_PROPERTY, axiomsByType, axiom, true);
            	functionalObjectPropertyAxiomsByProperty= removeAxiomFromSet(axiom.getProperty(), functionalObjectPropertyAxiomsByProperty, axiom, true);
            }
        }
...
//                addToIndexedSet(axiom.getSubProperty(), objectSubPropertyAxiomsByLHS, axiom);
//                addToIndexedSet(axiom.getSuperProperty(), objectSubPropertyAxiomsByRHS, axiom);
            	axiomsByType= addToIndexedSet(SUB_OBJECT_PROPERTY, axiomsByType, axiom);
            	objectSubPropertyAxiomsByLHS= addToIndexedSet(axiom.getSubProperty(), objectSubPropertyAxiomsByLHS, axiom);
            	objectSubPropertyAxiomsByRHS= addToIndexedSet(axiom.getSuperProperty(), objectSubPropertyAxiomsByRHS, axiom);
            } else {
...
//                removeAxiomFromSet(axiom.getSuperProperty(), objectSubPropertyAxiomsByRHS, axiom, true);
            	axiomsByType= removeAxiomFromSet(SUB_OBJECT_PROPERTY, axiomsByType, axiom, true);
            	objectSubPropertyAxiomsByLHS= removeAxiomFromSet(axiom.getSubProperty(), objectSubPropertyAxiomsByLHS, axiom, true);
            	objectSubPropertyAxiomsByRHS= removeAxiomFromSet(axiom.getSuperProperty(), objectSubPropertyAxiomsByRHS, axiom, true);
            }
        }
...
//                addToIndexedSet(axiom.getOWLClass(), classAxiomsByClass, axiom);
            	axiomsByType= addToIndexedSet(DISJOINT_UNION, axiomsByType, axiom);
            	disjointUnionAxiomsByClass= addToIndexedSet(axiom.getOWLClass(), disjointUnionAxiomsByClass, axiom);
            	classAxiomsByClass= addToIndexedSet(axiom.getOWLClass(), classAxiomsByClass, axiom);
            } else {
...
//                removeAxiomFromSet(axiom.getOWLClass(), classAxiomsByClass, axiom, true);
            	axiomsByType= removeAxiomFromSet(DISJOINT_UNION, axiomsByType, axiom, true);
            	disjointUnionAxiomsByClass= removeAxiomFromSet(axiom.getOWLClass(), disjointUnionAxiomsByClass, axiom, true);
            	classAxiomsByClass= removeAxiomFromSet(axiom.getOWLClass(), classAxiomsByClass, axiom, true);
            }
        }
...
//                addToIndexedSet(DECLARATION, axiomsByType, axiom);
            	axiomsByType= addToIndexedSet(DECLARATION, axiomsByType, axiom);
            } else {
//                removeAxiomFromSet(DECLARATION, axiomsByType, axiom, true);
            	axiomsByType= removeAxiomFromSet(DECLARATION, axiomsByType, axiom, true);
            }
        }
...
//                addToIndexedSet(axiom.getSubject(), annotationAssertionAxiomsBySubject, axiom);
            	axiomsByType= addToIndexedSet(ANNOTATION_ASSERTION, axiomsByType, axiom);
            	annotationAssertionAxiomsBySubject= addToIndexedSet(axiom.getSubject(), annotationAssertionAxiomsBySubject, axiom);
            } else {
...
//                removeAxiomFromSet(axiom.getSubject(), annotationAssertionAxiomsBySubject, axiom, true);
            	axiomsByType= removeAxiomFromSet(ANNOTATION_ASSERTION, axiomsByType, axiom, true);
            	annotationAssertionAxiomsBySubject= removeAxiomFromSet(axiom.getSubject(), annotationAssertionAxiomsBySubject, axiom, true);
            }
        }
...
//                addToIndexedSet(ANNOTATION_PROPERTY_DOMAIN, axiomsByType, axiom);
            	axiomsByType= addToIndexedSet(ANNOTATION_PROPERTY_DOMAIN, axiomsByType, axiom);
            } else {
//                removeAxiomFromSet(ANNOTATION_PROPERTY_DOMAIN, axiomsByType, axiom, true);
            	axiomsByType= removeAxiomFromSet(ANNOTATION_PROPERTY_DOMAIN, axiomsByType, axiom, true);
            }
        }
...
//                addToIndexedSet(ANNOTATION_PROPERTY_RANGE, axiomsByType, axiom);
            	axiomsByType= addToIndexedSet(ANNOTATION_PROPERTY_RANGE, axiomsByType, axiom);
            } else {
//                removeAxiomFromSet(ANNOTATION_PROPERTY_RANGE, axiomsByType, axiom, true);
            	axiomsByType= removeAxiomFromSet(ANNOTATION_PROPERTY_RANGE, axiomsByType, axiom, true);
            }
        }
...
//                addToIndexedSet(SUB_ANNOTATION_PROPERTY_OF, axiomsByType, axiom);
            	axiomsByType= addToIndexedSet(SUB_ANNOTATION_PROPERTY_OF, axiomsByType, axiom);
            } else {
//                removeAxiomFromSet(SUB_ANNOTATION_PROPERTY_OF, axiomsByType, axiom, true);
            	axiomsByType= removeAxiomFromSet(SUB_ANNOTATION_PROPERTY_OF, axiomsByType, axiom, true);
            }
        }
...
//                addToIndexedSet(HAS_KEY, axiomsByType, axiom);
            	axiomsByType= addToIndexedSet(HAS_KEY, axiomsByType, axiom);
                if (!axiom.getClassExpression().isAnonymous()) {
//                    addToIndexedSet(axiom.getClassExpression().asOWLClass(), hasKeyAxiomsByClass, axiom);
                	hasKeyAxiomsByClass= addToIndexedSet(axiom.getClassExpression().asOWLClass(), hasKeyAxiomsByClass, axiom);
                }
...
//                removeAxiomFromSet(HAS_KEY, axiomsByType, axiom, true);
            	axiomsByType= removeAxiomFromSet(HAS_KEY, axiomsByType, axiom, true);
                if (!axiom.getClassExpression().isAnonymous()) {
//                    removeAxiomFromSet(axiom.getClassExpression().asOWLClass(), hasKeyAxiomsByClass, axiom, true);
                	hasKeyAxiomsByClass= removeAxiomFromSet(axiom.getClassExpression().asOWLClass(), hasKeyAxiomsByClass, axiom, true);
                }
            }
        }
...
//                addToIndexedSet(axiom.getProperty(), symmetricPropertyAxiomsByProperty, axiom);
            	axiomsByType= addToIndexedSet(SYMMETRIC_OBJECT_PROPERTY, axiomsByType, axiom);
            	symmetricPropertyAxiomsByProperty= addToIndexedSet(axiom.getProperty(), symmetricPropertyAxiomsByProperty, axiom);
            } else {
...
//                removeAxiomFromSet(axiom.getProperty(), symmetricPropertyAxiomsByProperty, axiom, true);
            	axiomsByType= removeAxiomFromSet(SYMMETRIC_OBJECT_PROPERTY, axiomsByType, axiom, true);
            	symmetricPropertyAxiomsByProperty= removeAxiomFromSet(axiom.getProperty(), symmetricPropertyAxiomsByProperty, axiom, true);
            }
        }
...
//                addToIndexedSet(axiom.getProperty(), dataPropertyRangeAxiomsByProperty, axiom);
            	axiomsByType= addToIndexedSet(DATA_PROPERTY_RANGE, axiomsByType, axiom);
            	dataPropertyRangeAxiomsByProperty= addToIndexedSet(axiom.getProperty(), dataPropertyRangeAxiomsByProperty, axiom);
            } else {
...
//                removeAxiomFromSet(axiom.getProperty(), dataPropertyRangeAxiomsByProperty, axiom, true);
            	axiomsByType= removeAxiomFromSet(DATA_PROPERTY_RANGE, axiomsByType, axiom, true);
            	dataPropertyRangeAxiomsByProperty= removeAxiomFromSet(axiom.getProperty(), dataPropertyRangeAxiomsByProperty, axiom, true);
            }
        }
...
//                addToIndexedSet(axiom.getProperty(), functionalDataPropertyAxiomsByProperty, axiom);
            	axiomsByType= addToIndexedSet(FUNCTIONAL_DATA_PROPERTY, axiomsByType, axiom);
            	functionalDataPropertyAxiomsByProperty= addToIndexedSet(axiom.getProperty(), functionalDataPropertyAxiomsByProperty, axiom);
            } else {
...
//                removeAxiomFromSet(axiom.getProperty(), functionalDataPropertyAxiomsByProperty, axiom, true);
            	axiomsByType= removeAxiomFromSet(FUNCTIONAL_DATA_PROPERTY, axiomsByType, axiom, true);
            	functionalDataPropertyAxiomsByProperty= removeAxiomFromSet(axiom.getProperty(), functionalDataPropertyAxiomsByProperty, axiom, true);
            }
        }
...
//                addToIndexedSet(EQUIVALENT_DATA_PROPERTIES, axiomsByType, axiom);
            	axiomsByType= addToIndexedSet(EQUIVALENT_DATA_PROPERTIES, axiomsByType, axiom);
                for (OWLDataPropertyExpression prop : axiom.getProperties()) {
//                    addToIndexedSet(prop, equivalentDataPropertyAxiomsByProperty, axiom);
                	equivalentDataPropertyAxiomsByProperty= addToIndexedSet(prop, equivalentDataPropertyAxiomsByProperty, axiom);
                }
...
//                removeAxiomFromSet(EQUIVALENT_DATA_PROPERTIES, axiomsByType, axiom, true);
            	axiomsByType= removeAxiomFromSet(EQUIVALENT_DATA_PROPERTIES, axiomsByType, axiom, true);
                for (OWLDataPropertyExpression prop : axiom.getProperties()) {
//                    removeAxiomFromSet(prop, equivalentDataPropertyAxiomsByProperty, axiom, true);
                	equivalentDataPropertyAxiomsByProperty= removeAxiomFromSet(prop, equivalentDataPropertyAxiomsByProperty, axiom, true);
                }
            }
        }
...
//                addToIndexedSet(CLASS_ASSERTION, axiomsByType, axiom);
            	classAssertionAxiomsByIndividual= addToIndexedSet(axiom.getIndividual(), classAssertionAxiomsByIndividual, axiom);
                axiomsByType= addToIndexedSet(CLASS_ASSERTION, axiomsByType, axiom);
                if (!axiom.getClassExpression().isAnonymous()) {
//                    addToIndexedSet((OWLClass) axiom.getClassExpression(), classAssertionAxiomsByClass, axiom);
                	classAssertionAxiomsByClass= addToIndexedSet((OWLClass) axiom.getClassExpression(), classAssertionAxiomsByClass, axiom);
                }
...
//                removeAxiomFromSet(axiom.getIndividual(), classAssertionAxiomsByIndividual, axiom, true);
            	axiomsByType= removeAxiomFromSet(CLASS_ASSERTION, axiomsByType, axiom, true);
            	classAssertionAxiomsByIndividual= removeAxiomFromSet(axiom.getIndividual(), classAssertionAxiomsByIndividual, axiom, true);
                if (!axiom.getClassExpression().isAnonymous()) {
//                    removeAxiomFromSet((OWLClass) axiom.getClassExpression(), classAssertionAxiomsByClass, axiom, true);
                	classAssertionAxiomsByClass= removeAxiomFromSet((OWLClass) axiom.getClassExpression(), classAssertionAxiomsByClass, axiom, true);
                }
            }
        }
...
//                addToIndexedSet(EQUIVALENT_CLASSES, axiomsByType, axiom);
            	axiomsByType= addToIndexedSet(EQUIVALENT_CLASSES, axiomsByType, axiom);
                boolean allAnon = true;
                for (OWLClassExpression desc : axiom.getClassExpressions()) {
                    if (!desc.isAnonymous()) {
//                        addToIndexedSet((OWLClass) desc, equivalentClassesAxiomsByClass, axiom);
//                        addToIndexedSet((OWLClass) desc, classAxiomsByClass, axiom);
                    	equivalentClassesAxiomsByClass= addToIndexedSet((OWLClass) desc, equivalentClassesAxiomsByClass, axiom);
                    	classAxiomsByClass= addToIndexedSet((OWLClass) desc, classAxiomsByClass, axiom);
                        allAnon = false;
                    }
                }
                if (allAnon) {
...
//                removeAxiomFromSet(EQUIVALENT_CLASSES, axiomsByType, axiom, true);
            	axiomsByType= removeAxiomFromSet(EQUIVALENT_CLASSES, axiomsByType, axiom, true);
                boolean allAnon = true;
                for (OWLClassExpression desc : axiom.getClassExpressions()) {
                    if (!desc.isAnonymous()) {
...
//                        removeAxiomFromSet((OWLClass) desc, classAxiomsByClass, axiom, true);
                    	equivalentClassesAxiomsByClass= removeAxiomFromSet((OWLClass) desc, equivalentClassesAxiomsByClass, axiom, true);
                    	classAxiomsByClass= removeAxiomFromSet((OWLClass) desc, classAxiomsByClass, axiom, true);
                        allAnon = false;
                    }
                }
                if (allAnon) {
...
//                addToIndexedSet(axiom.getSubject(), dataPropertyAssertionsByIndividual, axiom);
            	axiomsByType= addToIndexedSet(DATA_PROPERTY_ASSERTION, axiomsByType, axiom);
            	dataPropertyAssertionsByIndividual= addToIndexedSet(axiom.getSubject(), dataPropertyAssertionsByIndividual, axiom);
            } else {
...
//                removeAxiomFromSet(axiom.getSubject(), dataPropertyAssertionsByIndividual, axiom, true);
            	axiomsByType= removeAxiomFromSet(DATA_PROPERTY_ASSERTION, axiomsByType, axiom, true);
            	dataPropertyAssertionsByIndividual= removeAxiomFromSet(axiom.getSubject(), dataPropertyAssertionsByIndividual, axiom, true);
            }
        }
...
//                addToIndexedSet(axiom.getProperty(), transitivePropertyAxiomsByProperty, axiom);
            	axiomsByType= addToIndexedSet(TRANSITIVE_OBJECT_PROPERTY, axiomsByType, axiom);
            	transitivePropertyAxiomsByProperty= addToIndexedSet(axiom.getProperty(), transitivePropertyAxiomsByProperty, axiom);
            } else {
...
//                removeAxiomFromSet(axiom.getProperty(), transitivePropertyAxiomsByProperty, axiom, true);
            	axiomsByType= removeAxiomFromSet(TRANSITIVE_OBJECT_PROPERTY, axiomsByType, axiom, true);
            	transitivePropertyAxiomsByProperty= removeAxiomFromSet(axiom.getProperty(), transitivePropertyAxiomsByProperty, axiom, true);
            }
        }
...
//                addToIndexedSet(axiom.getProperty(), irreflexivePropertyAxiomsByProperty, axiom);
            	axiomsByType= addToIndexedSet(IRREFLEXIVE_OBJECT_PROPERTY, axiomsByType, axiom);
            	irreflexivePropertyAxiomsByProperty= addToIndexedSet(axiom.getProperty(), irreflexivePropertyAxiomsByProperty, axiom);
            } else {
...
//                removeAxiomFromSet(axiom.getProperty(), irreflexivePropertyAxiomsByProperty, axiom, true);
            	axiomsByType= removeAxiomFromSet(IRREFLEXIVE_OBJECT_PROPERTY, axiomsByType, axiom, true);
            	irreflexivePropertyAxiomsByProperty= removeAxiomFromSet(axiom.getProperty(), irreflexivePropertyAxiomsByProperty, axiom, true);
            }
        }
...
//                addToIndexedSet(axiom.getSubProperty(), dataSubPropertyAxiomsByLHS, axiom);
//                addToIndexedSet(axiom.getSuperProperty(), dataSubPropertyAxiomsByRHS, axiom);
            	axiomsByType= addToIndexedSet(SUB_DATA_PROPERTY, axiomsByType, axiom);
            	dataSubPropertyAxiomsByLHS= addToIndexedSet(axiom.getSubProperty(), dataSubPropertyAxiomsByLHS, axiom);
            	dataSubPropertyAxiomsByRHS= addToIndexedSet(axiom.getSuperProperty(), dataSubPropertyAxiomsByRHS, axiom);
            } else {
...
//                removeAxiomFromSet(axiom.getSuperProperty(), dataSubPropertyAxiomsByRHS, axiom, true);
            	axiomsByType= removeAxiomFromSet(SUB_DATA_PROPERTY, axiomsByType, axiom, true);
            	dataSubPropertyAxiomsByLHS= removeAxiomFromSet(axiom.getSubProperty(), dataSubPropertyAxiomsByLHS, axiom, true);
            	dataSubPropertyAxiomsByRHS= removeAxiomFromSet(axiom.getSuperProperty(), dataSubPropertyAxiomsByRHS, axiom, true);
            }
        }
...
//                addToIndexedSet(axiom.getProperty(), inverseFunctionalPropertyAxiomsByProperty, axiom);
            	axiomsByType= addToIndexedSet(INVERSE_FUNCTIONAL_OBJECT_PROPERTY, axiomsByType, axiom);
            	inverseFunctionalPropertyAxiomsByProperty= addToIndexedSet(axiom.getProperty(), inverseFunctionalPropertyAxiomsByProperty, axiom);
            } else {
...
//                removeAxiomFromSet(axiom.getProperty(), inverseFunctionalPropertyAxiomsByProperty, axiom, true);
            	axiomsByType= removeAxiomFromSet(INVERSE_FUNCTIONAL_OBJECT_PROPERTY, axiomsByType, axiom, true);
            	inverseFunctionalPropertyAxiomsByProperty= removeAxiomFromSet(axiom.getProperty(), inverseFunctionalPropertyAxiomsByProperty, axiom, true);
            }
        }
...
//                addToIndexedSet(SAME_INDIVIDUAL, axiomsByType, axiom);
            	axiomsByType= addToIndexedSet(SAME_INDIVIDUAL, axiomsByType, axiom);
                for (OWLIndividual ind : axiom.getIndividuals()) {
//                    addToIndexedSet(ind, sameIndividualsAxiomsByIndividual, axiom);
                	sameIndividualsAxiomsByIndividual= addToIndexedSet(ind, sameIndividualsAxiomsByIndividual, axiom);
                }
...
//                removeAxiomFromSet(SAME_INDIVIDUAL, axiomsByType, axiom, true);
            	axiomsByType= removeAxiomFromSet(SAME_INDIVIDUAL, axiomsByType, axiom, true);
                for (OWLIndividual ind : axiom.getIndividuals()) {
//                    removeAxiomFromSet(ind, sameIndividualsAxiomsByIndividual, axiom, true);
                	sameIndividualsAxiomsByIndividual= removeAxiomFromSet(ind, sameIndividualsAxiomsByIndividual, axiom, true);
                }
            }
        }
...
//                addAxiomToSet(axiom, propertyChainSubPropertyAxioms);
            	axiomsByType= addToIndexedSet(SUB_PROPERTY_CHAIN_OF, axiomsByType, axiom);
            	propertyChainSubPropertyAxioms= addAxiomToSet(axiom, propertyChainSubPropertyAxioms);
            } else {
//                removeAxiomFromSet(SUB_PROPERTY_CHAIN_OF, axiomsByType, axiom, true);
//                removeAxiomFromSet(axiom, propertyChainSubPropertyAxioms);
            	axiomsByType= removeAxiomFromSet(SUB_PROPERTY_CHAIN_OF, axiomsByType, axiom, true);
            	propertyChainSubPropertyAxioms= removeAxiomFromSet(axiom, propertyChainSubPropertyAxioms);
            }
        }
...
//                addToIndexedSet(SWRL_RULE, axiomsByType, rule);
            	axiomsByType= addToIndexedSet(SWRL_RULE, axiomsByType, rule);
            } else {
//                removeAxiomFromSet(SWRL_RULE, axiomsByType, rule, true);
            	axiomsByType= removeAxiomFromSet(SWRL_RULE, axiomsByType, rule, true);
            }
        }
...
//                addToIndexedSet(DATATYPE_DEFINITION, axiomsByType, axiom);
            	axiomsByType= addToIndexedSet(DATATYPE_DEFINITION, axiomsByType, axiom);
            } else {
//                removeAxiomFromSet(DATATYPE_DEFINITION, axiomsByType, axiom, true);
            	axiomsByType= removeAxiomFromSet(DATATYPE_DEFINITION, axiomsByType, axiom, true);
            }
        }
    }
...
//    private static <K, V extends OWLAxiom> Set<V> getAxioms(K key, Map<K, Set<V>> map, boolean create) {
    private static <K, V extends OWLAxiom> Set<V> getAxiomsGen(K key, Map<K, Set<V>> map) {
        Set<V> axioms = map.get(key);
        if (axioms == null) {
...
//            }
     ...
     * New method
     */
    static <T> Set<T> addToSet(Set<T> set, T val){
        return (Set<T>) ((IPersistentSet) set).cons(val);
    }

    /**
     * New method
     */
    static <T> Set<T> remFromSet(Set<T> set, T val){
        try {
			return (Set<T>) ((IPersistentSet) set).disjoin(val);
		} catch (Exception e) {
			return set;
		}
    }
...
//        axioms.add(axiom);
      ...
      private static <K, V extends OWLAxiom> Map<K, Set<V>> addToIndexedSet(K key, Map<K, Set<V>> map, V axiom) {
        if (map == null) {
            return map;
        }
        Set<V> axioms = map.get(key);
        ...
        if (axioms == null) {
            axioms = (Set<V>) PersistentHashSet.create();
        }
        axioms= (Set<V>) ((IPersistentSet) axioms).cons(axiom);
        return (Map<K, Set<V>>) ((IPersistentMap) map).assoc(key, axioms);
    }
...
//    }
      ...
      private static <K, V extends OWLAxiom> Map<K, Set<V>> removeAxiomFromSet(K key, Map<K, Set<V>> map, V axiom,
    		  													boolean removeSetIfEmpty) {
    	  if (map == null) {
    		  return null;
    	  }
    	  Set axioms = map.get(key);
    	  if (axioms == null)
    		  return map;
    	  try {
    		  axioms= (Set) ((IPersistentSet) axioms).disjoin(axiom);
    	  } catch (Exception e) {
    		  return map;
    	  }
    	  if (removeSetIfEmpty && axioms.isEmpty())
    		  try {
    			  return (Map<K, Set<V>>) ((IPersistentMap) map).without(key);
    		  } catch (Exception e) {
    			  return map;
    		  }
...
//    }
    ...
    private static <K extends OWLAxiom> Set<K> addAxiomToSet(K axiom, Set<K> axioms) {
        if (axioms != null && axiom != null) {
            return (Set<K>) ((IPersistentSet) axioms).cons(axiom);
        }
        return axioms;
    }
...
//    }
    ...
    private static <K extends OWLAxiom> Set<K> removeAxiomFromSet(K axiom, Set<K> axioms) {
        if (axioms != null) {
        	try {
				return (Set<K>) ((IPersistentSet) axioms).disjoin(axiom);
			} catch (Exception e) {}
        }
        return axioms;
    }
...
//    }
    ...
    private void buildClassAxiomsByClassIndex() {
    	//TODO change to a make map closure helper to make it more eficient
...
//                addToIndexedSet((OWLClass) axiom.getSubClass(), classAxiomsByClass, axiom);
            	classAxiomsByClass= addToIndexedSet((OWLClass) axiom.getSubClass(), classAxiomsByClass, axiom);
            }
        }
...
//        return getReturnSet(getAxioms(subject, annotationAssertionAxiomsBySubject, false));
        return getReturnSet(getAxiomsGen(subject, annotationAssertionAxiomsBySubject));
    }
