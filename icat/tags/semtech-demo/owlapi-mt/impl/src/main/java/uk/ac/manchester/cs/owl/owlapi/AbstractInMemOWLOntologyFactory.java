...
public abstract class AbstractInMemOWLOntologyFactory implements OWLOntologyFactory {
    ...
    private volatile OWLOntologyManager ontologyManager;
     ...
     * @param documentIRI
     */
    public synchronized OWLOntology createOWLOntology(OWLOntologyID ontologyID, IRI documentIRI, OWLOntologyCreationHandler handler) throws OWLOntologyCreationException {
        if(ontologyManager == null) {
            throw new NullPointerException();
        }
//        OWLOntology ont = new OWLOntologyImpl(ontologyManager, ontologyID);
        OWLOntology ont = new OWLMutableOntologyImpl(ontologyManager, ontologyID);
