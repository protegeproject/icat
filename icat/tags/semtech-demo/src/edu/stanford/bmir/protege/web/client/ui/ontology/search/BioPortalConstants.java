...
public class BioPortalConstants {
    ...
    static String DEFAULT_BIOPORTAL_VISUALIZE_URL = "http://bioportal.bioontology.org/visualize/";
    // private static String DEFAULT_BIOPORTAL_VISUALIZE_URL = "http://stage.bioontology.org/visualize/";
    // private static String DEFAULT_BIOPORTAL_VISUALIZE_URL = "http://bioportal.bioontology.org/visconcepts/";
    // private static String DEFAULT_BIOPORTAL_VISUALIZE_URL = "http://stage.bioontology.org/visconcepts/";
    static String DEFAULT_BIOPORTAL_ONTOLOGY_URL = "http://bioportal.bioontology.org/ontologies/";
    // private static String DEFAULT_BIOPORTAL_ONTOLOGY_URL = "http://stage.bioontology.org/ontologies/";
    static String DEFAULT_BIOPORTAL_REST_BASE_URL = "http://rest.bioontology.org/bioportal/"; //production
    // private static String DEFAULT_BIOPORTAL_REST_BASE_URL = "http://stagerest.stanford.edu/bioportal/"; //stage
    static String DEFAULT_BIOPORTAL_SEARCH_URL = "http://rest.bioontology.org/bioportal/search/"; //production
    // private static String DEFAULT_BIOPORTAL_SEARCH_URL = "http://stagerest.stanford.edu/bioportal/search/"; //stage
    ...
    static String CONFIG_PROPERTY_ONTOLGY_ID_PROPERTY = "ontology_id_property";
    static String CONFIG_PROPERTY_CONCEPT_ID_PROPERTY = "concept_id_property";
    ...
    static String CONFIG_PROPERTY_BIOPORTAL_BASE_URL = "bioportal_base_url";
    static String CONFIG_PROPERTY_BIOPORTAL_REST_BASE_URL = "bioportal_rest_base_url";
